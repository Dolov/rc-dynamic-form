...
const Components = {
  ...
  MAP(props) {
    return React.createElement(SelectMap, props);
  },

  CASCADER(props) {
    return React.createElement(_Cascader, props);
  },

  TIMEPICKER(props) {
    return React.createElement(_TimePicker, _extends({
      style: style
    }, props));
  },
  ...
  TRANSFER(props) {
    ...
    return React.createElement(_Transfer, _extends({
